package br.com.sthefanny.aula01homework01
...
class MainActivity : AppCompatActivity() {
    ...
    private val votesList = mutableListOf(0, 0, 0)
    ...
    fun btnVoteOnClick(view: View) {
        when(grpVote.checkedRadioButtonId) {
            ...
            R.id.optR10 -> votesList[2]++
                ...
                Toast.makeText(this, "Escolha uma da opções de voto", Toast.LENGTH_SHORT).show()
            }
        }
