...
class TabIndicationPainter extends CustomPainter {
  ...
  TabIndicationPainter({this.dxTarget = 125.0, this.dxEntry = 25.0, this.radius = 21.0, this.dy = 25.0, this.pageController}) : super(repaint: pageController) {
    painter = Paint()
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final Path path = Path()
      ...
      ..addArc(Rect.fromCircle(center: target, radius: radius), 1.5 * pi, 1 * pi);
